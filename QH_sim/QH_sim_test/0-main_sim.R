...
# -------------------------------------------------- #
R_address = "C:/Users/qihan/Desktop/QH_sim_test"
w1_address= "C:/Users/qihan/Desktop/QH_sim_test"
# -------------------------------------------------- #
...
library(parallel)
worker.script = '1-Parameter_sim_testuse.R'
...
seed2024 = as.matrix(read.csv("C:/Users/qihan/Desktop/QH_sim_test/seed2024.csv", header = TRUE))
...
rdata_name = strwrap(paste("sim2_",nreps,"n_", nall,"_", keepN, ".Rdata",sep=""))
