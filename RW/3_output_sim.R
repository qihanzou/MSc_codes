...
resTrf = function(res){
  ...
  ThetaRB = ThetaKR  = Nout = XiSI = NULL
  ...
  for(z in 1:1000){
    ...
    VarSI    = cbind(VarSI, res[[z]]$varbeta_sim)
  ...
  return(list(BetaOLS = BetaOLS, BetaRB = BetaRB, BetaKR = BetaKR,
              ...
              ThetaRB = ThetaRB, ThetaKR = ThetaKR, Nout = Nout))
}
...
setwd("C:/Users/qihan/Desktop/QH_sim")

nameRdata=strwrap(paste("sim_1000n_400_200.Rdata"))
load(nameRdata)
betas0 = c(2,beta1)
out = resTrf(res)
