...
Expand_theta2 = function(theta0_est_i, theta1_est_i, dtheta0, dtheta1){
  ...
  Var_theta0 = cbind(theta0_up, theta0_down)
  Var_theta1 = cbind(theta1_up, theta1_down)
  
  Var_data = expand.grid(Var_theta0, Var_theta1)
}
