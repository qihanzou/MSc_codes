...
w1_address= "C:/Users/qihan/Desktop/QH_rw"
# -------------------------------------------------- #
...
library(parallel)
worker.script = '1-Parameter_rw07_method3.R'
...
seed2024 = as.matrix(read.csv("C:/Users/qihan/Desktop/QH_rw/seed2024.csv", header = TRUE))
...
rdata_name = strwrap(paste("Qihan_rw07_",nreps,"n_", nall,"_", keepN,"_mc100_ci975" ,".Rdata",sep=""))
