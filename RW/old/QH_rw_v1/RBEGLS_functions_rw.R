RBEGLS_loop_New4 = function(iter, btor, ttor, betaest, thetaest, theta_ep.ini, CovU1, CovU2, y, W, Dall, cov_ep, lo.bounde,up.bounde){
...
RBEGLS_loop_mod1 = function(iter, btor, ttor, betaest, thetaest, theta_ep.ini, CovU1, y, W, Dall, cov_ep, lo.bounde,up.bounde){
...
RBEGLS_loop_mod2 = function(iter, btor, ttor, betaest, thetaest, theta_ep.ini, CovU1, y, W, Dall, cov_ep, lo.bounde,up.bounde){
