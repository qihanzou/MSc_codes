...
resTrf = function(res){
  ...
  for(z in 1:1000){
    ...
    Var_v3_m100 = cbind(Var_v3_m100, res[[z]]$varbeta_v3_zmean100)
...
n = 800
nameRdata=strwrap(paste("Qihan_f2_1000n_", n, "_", n/2, "_mc100.Rdata", sep=""))
load(nameRdata)
betas0 = c(2,beta1)
out = resTrf(res)
...
TRB_v3_m100 = outcover(t(out$BetaRB), t(out$Var_v3_m100)^.5, betas0)
...
# 
library("xtable")  
T1 = cbind(t(TO), t(TKR), t(TRB), t(TMC), t(TRB_v3_m100))
# 
