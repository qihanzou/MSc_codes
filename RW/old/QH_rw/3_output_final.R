...
resTrf = function(res){
  ...
  VarOLS = VarRB = VarRW1  = VarRW_v3 = VarMC = VarKR  = NULL
  XiRB  = ALPHARB = NULL
  ...
  for(z in 1:1000){
    ...
    VarRW_v3 = cbind(VarRW_v3, res[[z]]$varbeta_v3)
...
n = 800
nameRdata=strwrap(paste("Qihan_final_1000n_", n, "_", n/2, "_mc100_ci95.Rdata", sep=""))
load(nameRdata)
betas0 = c(2,beta1)
out = resTrf(res)
