...
varbeta_rw_v2_max = c(max(Var_Res_v2[1,]), max(Var_Res_v2[2,]))
varbeta_rw_v3_mean = rowMeans(Var_Res_v3)
varbeta_rw_v3_max = c(max(Var_Res_v3[1,]), max(Var_Res_v3[2,]))
...
list(alpha_est = out1$beta,
     ...
     varbeta_rw_v2_max = as.matrix(varbeta_rw_v2_max),
     
     varbeta_rw_v3_mean = as.matrix(varbeta_rw_v3_mean),
     varbeta_rw_v3_max = as.matrix(varbeta_rw_v3_max),
