...
# -------------------------------------------------- #
R_address = "C:/Users/qihan/Desktop/QH - Copy"
w1_address= "C:/Users/qihan/Desktop/QH - Copy"
# -------------------------------------------------- #
# choose parameters
# -------------------------------------------------- #
...
seedtj = as.matrix(read.csv("seedtj1.csv", header = TRUE))
res = foreach(iter = iter0, .combine=list,.maxcombine=max(nreps,2),.options.RNG = seedtj,
