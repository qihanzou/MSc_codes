...
RBEGLS_loop_New3 = function(iter, btor, ttor, betaest, thetaest, theta_ep.ini, CovU1, CovU2, CovU3, y, W, Dall, cov_ep, lo.bounde,up.bounde){
  ...
  while ((b_diff > btor | t_diff > ttor)&iter0 < iter){
    ...
    CovUB3 = CovU3*betaest[5]^2
    
    CovUB = CovUB1 + CovUB2 + CovUB3
