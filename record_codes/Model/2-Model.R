...
plot(Local_gas$X, Local_gas$Y, cex = 0.5, pch = 21, xlab = "s1", ylab = "s2")
points(Local_data$X, Local_data$Y, cex = 0.5, pch = 19)
...
Ytrain = y = as.matrix(select(train, c("Z_O3N2"))) # need change. !!!!!!!!!!!!!!!!!!
