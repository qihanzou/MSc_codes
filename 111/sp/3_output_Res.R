...
resTrf = function(res){
  ...
  for(z in 1:1000){
    ...
    VarMC    = cbind(VarMC, res[[z]]$varbeta_lap)
    VarSI    = cbind(VarSI, res[[z]]$varbeta_lap2 ) 
...
setwd("C:/Users/qihan/Desktop/Res")

nameRdata=strwrap(paste("Res_1000n_800_400.Rdata"))
load(nameRdata)
betas0 = c(2,beta1)
out = resTrf(res)
...
TLP1 = outcover(t(out$BetaRB), t(out$VarMC)^.5, betas0)
TLP2 = outcover(t(out$BetaRB), t(out$VarSI)^.5, betas0)
