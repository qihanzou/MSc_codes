...
w1_address= "C:/Users/qihan/Desktop/QH_new"
# -------------------------------------------------- #
# choose parameters
# -------------------------------------------------- #
...
library(parallel)
worker.script = '1-Parameter_ab4.R'
...
seed2024 = as.matrix(read.csv("C:/Users/qihan/Desktop/QH_new/seed2024.csv", header = TRUE))
...
rdata_name = strwrap(paste("ab4_zeta0is2_X",nreps,"n_", nall,"_", keepN, ".Rdata",sep=""))
