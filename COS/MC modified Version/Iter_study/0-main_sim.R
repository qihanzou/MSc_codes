...
# -------------------------------------------------- #
R_address = "C:/Users/qihan/Desktop/QH_sim2_ab4_iter_study"
w1_address= "C:/Users/qihan/Desktop/QH_sim2_ab4_iter_study"
# -------------------------------------------------- #
...
library(parallel)
worker.script = '1-Parameter_sim2_ab4_iter_study.R'
...
seed2024 = as.matrix(read.csv("C:/Users/qihan/Desktop/QH_sim/seed2024.csv", header = TRUE))
...
rdata_name = strwrap(paste("SIM_ab4_MCiter_", MC_iter, "_reps_",nreps,"n_", nall,"_", keepN, ".Rdata",sep=""))
