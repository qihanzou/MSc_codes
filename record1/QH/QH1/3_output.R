...
resTrf = function(res){
  ...
  for(i in 1:nreps){
    ...
    VarKR = rbind(VarKR, res[[i]]$varbeta_kr)    # Kr var
    
    VarKRm = rbind(VarKRm, res[[i]]$varbeta_krm) #
    
    VarRB = rbind(VarRB, res[[i]]$varbeta_rb)    # RBEGLS var
    VarRBm = rbind(VarRBm, res[[i]]$varbeta_rbm) # mc RBEGLS var
...
#setwd("C:/Users/tingjinc/Desktop/RCodes/1QH")
#setwd("C:/Users/tingjinc/Desktop/RCodes/1QH/NewSimuB4")
#setwd("C:/Users/tingjinc/Desktop/RCodes/1QH/NewSimuB1")
setwd("C:/Users/qihan/Desktop/Qihan/result 1")
...
for (fi in 1:4){
  nsam = c(200,200,400,400)
  n = nsam[fi]
  nameRdata=strwrap(paste("X1000n_", n, "_", n/2, ".Rdata", sep=""))
  load(nameRdata)
...
library("xtable")  
T1 = cbind(TabK, TabR[,-1], TabRm[,-(1:4)])
